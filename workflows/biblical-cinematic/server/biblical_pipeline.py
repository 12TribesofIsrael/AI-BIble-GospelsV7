...
# ---------------------------------------------------------------------------
# Claude prompt + batching — now lives in scene_director.py so scripts and CLIs
# can import it without pulling FastAPI in. Re-exported here for compatibility.
# ---------------------------------------------------------------------------
from scene_director import (  # noqa: E402,F401
    PROMPT_BATCH_SIZE, _request_prompt_batch, generate_image_prompts,
    image_prompt_system,
)
